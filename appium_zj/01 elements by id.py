...
class Androidtest(unittest.TestCase):
    ...
    def tearDown(self):
        ...
        pass
    def test_01(self):
        self.driver.find_element_by_id('cn.xiaochuankeji.tieba:id/title').click()  #默认第一个

    def test_02(self):
        self.driver.find_elements_by_id("cn.xiaochuankeji.tieba:id/title")[3].click()      #查找到的为id这样的全部，然后为list类型
